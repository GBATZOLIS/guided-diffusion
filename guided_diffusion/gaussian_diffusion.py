...
class GaussianDiffusion:
    ...
    def condition_mean(self, cond_fn, p_mean_var, x, t, model_kwargs=None):
        ...
        """
        gradient = cond_fn(x, self._scale_timesteps(t), **model_kwargs) # WARNING: Make sure the time scale is correct. Could be connected to wrapping models.
        new_mean = (
    ...
    def scoreVAE_training_losses(self, encoder, diffusion_model, x_start, t, model_kwargs=None, clip_denoised=False, noise=None, train=True):
        ...
        def get_encoder_correction_fn(encoder):
              ...
              def encoder_correction_fn(x_t, z, t):
                  if not train: 
                    th.set_grad_enabled(True)
        ...
        target = noise
        terms["reconstruction"] = mean_flat((target - corrected_eps) ** 2) #reconstruction term -> mean over all non batch dimensions
